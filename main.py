...
deliver_till = "1970-01-02T00:00:00-06:00" if interval_end == '24' else f"1970-01-01T{interval_end}:00:00-06:00"
start_routing_at = "1970-01-02T00:00:00-06:00" if interval_start == '24' else f"1970-01-01T{interval_start}:00:00-06:00"
...
st.write('Delivery window from', interval_start, 'to', interval_end, "–",
         str(int(interval_end) - int(interval_start)), "hours, Mexico time (GMT-6).\n",
